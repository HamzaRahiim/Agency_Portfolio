...
const features: PlanFeature[] = [
  { name: "Store setup & configuration", starter: true, gold: true, platinum: true },
  { name: "Theme customization", starter: false, gold: true, platinum: true },
  { name: "Product setup & management", starter: true, gold: true, platinum: true },
  { name: "Payment gateway setup", starter: true, gold: true, platinum: true },
  { name: "Shipping configuration", starter: false, gold: true, platinum: true },
  { name: "App integration", starter: false, gold: true, platinum: true },
  { name: "SEO optimization", starter: false, gold: false, platinum: true },
  { name: "Performance optimization", starter: false, gold: false, platinum: true },
  { name: "Number of products", starter: "Up to 50", gold: "Up to 200", platinum: "Unlimited" },
  { name: "Support (days)", starter: "7", gold: "30", platinum: "90" },
];
    ...
    <div className="w-full">
      ...
      <div className="text-center mb-8 sm:mb-12">
        <h3 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground mb-4 sm:mb-5">
          Shopify <span className="bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent">Development</span>
        </h3>
        <p className="text-muted-foreground text-sm sm:text-base mt-2">
          Professional Shopify store setup and optimization solutions
        </p>
      </div>
